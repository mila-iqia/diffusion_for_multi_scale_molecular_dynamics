...
This script draws samples from a checkpoint using the ODE sampler.
"""
import logging
import tempfile
...
samples_dir = Path("/network/scratch/r/rousseab/samples_EGNN_Sept_10_tight_sigmas/ODE/samples_v2")
...
if __name__ == '__main__':
    ...
    sample_output_path = str(samples_dir / "diffusion_position_samples.pt")
    ...
    energy_output_path = str(samples_dir / f"diffusion_energies_samples.pt")
