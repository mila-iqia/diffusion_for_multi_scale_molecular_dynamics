"""Draw Langevin with force Samples


This script draws samples from a checkpoint using the Langevin sampler, with forcing.
"""
import logging
import tempfile
...
from crystal_diffusion.models.score_networks.force_field_augmented_score_network import ForceFieldParameters, \
...
force_field_parameters = ForceFieldParameters(radial_cutoff=1.5, strength=1.)
...
if __name__ == '__main__':
    ...
    raw_sigma_normalized_score_network = pl_model.sigma_normalized_score_network

    sigma_normalized_score_network = ForceFieldAugmentedScoreNetwork(raw_sigma_normalized_score_network,
