...
from crystal_diffusion.data.data_loader import FashionMnistDM
from crystal_diffusion.models.model_loader import load_model
from crystal_diffusion.utils.hp_utils import check_and_log_hp
from crystal_diffusion.utils.logging_utils import LoggerWriter
...
def evaluate(args, data_dir, hyper_params):
    ...
    # TODO PL model loaded from checkpoint cannot be called from the cookiecutter approach
    # it has to be called as ModelClass.load_from_checkpoint(args.ckpt_path)
