...
This file was downloaded from the following link:
...
It is the authors' own implementation.

The file may be modified from the original download to fit our own linting style.
"""
import torch
