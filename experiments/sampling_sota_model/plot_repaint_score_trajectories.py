...
unconstrained_energy_pickle_path = Path(
    "/Users/bruno/courtois/draw_sota_samples/1x1x1/LANGEVIN/energy_samples.pt"
)
...
if __name__ == "__main__":
    ...
    fig0.tight_layout()
    fig0.savefig(
        base_path / "comparing_energy_distributions_unconstrained_vs_repaint.png"
    )
    plt.close(fig0)
