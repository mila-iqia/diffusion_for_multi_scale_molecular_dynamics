...
if __name__ == '__main__':
    ...
    list_relative_positions = train_dataset[:sample_size]['relative_positions'].cpu().numpy()
    ...
    ax2.hist(errors, density=True, bins=20, histtype="stepfilled", alpha=0.25, color='red')
