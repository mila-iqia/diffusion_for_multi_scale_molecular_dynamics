...
from diffusion_for_multi_scale_molecular_dynamics.data.diffusion.atom_types_demo_data_loader import (
    AtomTypesDataModule, AtomTypesDemoLoaderParameters)
...
def my_args():
    root_dir = "/Users/simonblackburn/projects/courtois2024/experiments/atom_types_demo/new_loss/chain_length64_8types/"
    args = DebuggerArgs(
        config=root_dir + "config.yaml",
        data=root_dir + "data/si_diffusion_1x1x1/",
...
def run(args, output_dir, hyper_params):
    ...
    if hyper_params["data"].get("atom_types_demo", False):
        del hyper_params["data"]["atom_types_demo"]
        data_params = AtomTypesDemoLoaderParameters(**hyper_params["data"])
        datamodule = AtomTypesDataModule(
