...
working_directory = experiment_dir / f"experiment_{experiment_id}"
...
optimizer_configuration = FlareOptimizerConfiguration(
...
if __name__ == "__main__":
    ...
    # the FLARE model.
    for campaign_id, uncertainty_threshold in zip(
        list_campaign_ids, list_uncertainty_thresholds
    ):
        active_learning_directory = (
            working_directory / f"active_learning_campaign_{campaign_id}"
        )
