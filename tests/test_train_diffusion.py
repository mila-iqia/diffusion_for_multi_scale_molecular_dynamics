...
class TestMain:
    ...
    @pytest.fixture()
    def config(self, number_of_atoms):
    ...
    @pytest.fixture()
    def paths(self, tmpdir, config, number_of_atoms):
    ...
    @pytest.fixture()
    def mock_get_lammps_output_method(self, monkeypatch):
