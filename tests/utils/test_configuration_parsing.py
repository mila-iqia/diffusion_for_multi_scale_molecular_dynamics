...
@pytest.fixture()
def options():
    return dict(first_kind=FirstKindDummyParameters, second_kind=SecondKindDummyParameters)


def test_create_parameters_from_configuration_dictionary(configuration, options, parameters):

    computed_parameters = create_parameters_from_configuration_dictionary(configuration=configuration,
                                                                          identifier='name',
                                                                          options=options)
