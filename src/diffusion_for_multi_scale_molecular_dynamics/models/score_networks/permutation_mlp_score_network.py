...
class PermutationMLPScoreNetwork(MLPScoreNetwork):
    ...
    def __init__(self, hyper_params: MLPScoreNetworkParameters):
        ...
        self.all_permutation_indices, self.all_inverse_permutation_indices = (
            self._get_all_permutation_indices(self._natoms))

    @staticmethod
    def _get_all_permutation_indices(number_of_atoms) -> torch.Tensor:
    ...
    def _forward_unchecked(
        ...
        for perm, inv_perm in zip(self.all_permutation_indices, self.all_inverse_permutation_indices):
            ...
            perm_axl_output = super()._forward_unchecked(permuted_batch, conditional)
